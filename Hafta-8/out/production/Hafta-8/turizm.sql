...
--
-- Anamakine: localhost
-- Üretim Zamanı: 09 Kas 2023, 19:48:30
...
CREATE TABLE `hotel` (
  ...
  `hotel_adress` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `hotel` (`hotel_id`, `hotel_name`, `hotel_city`, `hotel_district`, `hotel_feature`, `hotel_adress`, `hotel_mail`, `hotel_phone`, `hotel_star`) VALUES
...
--
ALTER TABLE `hotel`
  MODIFY `hotel_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `term`
  MODIFY `term_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
